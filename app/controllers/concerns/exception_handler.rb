module ExceptionHandler
  ...
  class InvalidInputFileType < StandardError; end
  class ExceptionHandler::UnprocessableEntity < StandardError; end
  ...
  included do
    ...
    rescue_from ExceptionHandler::InvalidInputFileType, with: :four_twenty_two
